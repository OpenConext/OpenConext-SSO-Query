...
public class DisableCacheInterceptorTest {
    ...
    @Test
    public void testExpireHeader() throws Exception {
    ...
    @Test
    public void testCacheHttp10Protocol() throws Exception {
        HandlerInterceptor interceptor = new DisableCacheInterceptor();
    ...
    @Test
    public void testCacheHttp11Protocol() throws Exception {
        HandlerInterceptor interceptor = new DisableCacheInterceptor();
